...
struct programa programas[]= {	//Nombre( identificacon menu)//Instalador (a no ser que tenga carpeta propia)//dir_fs			//dir_PC			//comando_silencioso 							//flag_instalar//flag_instalando//flag_instalo//flag_error
									...
									"Proxy              "   , " "                                       , 1 , " "                   , " "                   , "reg add \"HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings\" /v ProxyServer /t REG_SZ /d \"proxy.frba.utn.edu.ar:8080\" /f >null", 0, 0, 0, 0,
									"Imagen Inicio      "   , " "										, 1 , DIR_FS_PAPEL_INI	    , DIR_PC_PAPEL_INI      , "reg add \"HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Authentication\\LogonUI\\Background\" /v OEMBackground /t REG_DWORD /d 1 /f >>null" 			, 0, 0, 0, 0,
									"Servidor Time      "   , " "                                       , 1 , " "                   , " "                   , "reg add \"HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\services\\W32Time\\Parameters\" /v NtpServer /t REG_SZ /d \"time.frba.utn.edu.ar,0x9\" /f >>null"        , 1, 0, 0, 0,
									...
									"Adobe Reader       "	, "AdbeRdr"									, 2	, DIR_FS_BASICO 		, DIR_PC_BASICO			, " /sPB "										, 0, 0, 0, 0,
